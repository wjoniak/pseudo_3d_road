...
while True:
    ...
    curve=150;edje=470;offset=0.1;k=0
    while wall_bottom>plane_center+10:
        ...
        #to change the curve direction just change the sign before curve variable
        screen.blit(row_slice,(slice_x-curve,wall_bottom))
