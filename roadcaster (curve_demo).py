...
speed=1      #this is used to increment road_start
...
while True:
    ...
    while wall_bottom>plane_center+10:
        ...
        screen.blit(row_slice,(slice_x+curve[road_start+road_index]*direction,wall_bottom))
